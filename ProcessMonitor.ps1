<#
ProcessMonitor
Compact version so it can be pasted in a VM running in Hyper-V.
See also Dimmo module in PowerShell Gallery:
https://www.powershellgallery.com/packages/Dimmo/
#>

# Copy the code below this line so it can be pasted over a VMRC connection
$a = Get-Process
Do {
  Sleep 1
  $b = Get-Process
